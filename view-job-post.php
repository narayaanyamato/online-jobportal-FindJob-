...
?>
 ...
 <div class="container mt-5 p-t-3 mb-4 pb-5">
    <div class="row">
       <div class="col-lg-8 bg p-3 primary">
        ...
        ?>
                   ...
                   <h2 class="text-white"><i><?php echo $row['jobtitle']; ?></i></h2>
                    <div class="attachment-block clearfix p-3 bg-white rounded">
                    <div class="pull-left"><strong class="text-orange"><i class="bi bi-calendar"></i> <?php echo $row['post_on']; ?></strong></div>
                      ...
                      <?php 
                            if (empty($_SESSION['id'])){}else{
                             ?>
                             <button type="button" name="apply" class="btn btn-primary"><a class="text-white" href="user/apply.php?j_id=<?php echo $row['j_id'] ?>&&c_id=<?php echo $row['c_id']; ?>">Apply</a></button>
                             <?php 
                            }
           ...
           <div class="col-lg-4 bg p-3 primary">
            
                    <div class="attachment-block clearfix p-3 mt-5 bg-white rounded">
