...
<?php
  include('../db.php');
  $sql = "SELECT * FROM chatbox WHERE chat_id='$_GET[id]' and (id_user='$_SESSION[id]' OR id_touser='$_SESSION[id]')";
         ...
         <div class="col-lg-10 mb-5 bg p-3">
            <h2 class="text-white m-4"><a href="mails.php"><i class="bi bi-arrow-left-square-fill"></i></a> Read Message</i></h2>
             <div class="card border-top" >
              <div class="card-header"><h6 class="card-title">From : <?php if($row['fromuser']=='user') {echo $user['fname']; }else {echo $company['cname']; }?> <span class="text-right d-block"> <?php echo date("d-M-Y h:i a", strtotime($row['creat_on'])); ?></span> </h6></div>
                  ...
                  <div class="box box-primary">
                    <div class="card p-3  bg-white rounded">
                      <div class="mailbox-read-info">
                        ...
                        <h6>From: <?php if($rowReply['usertype'] == "user") { echo $user['fname']; } else { echo $company['cname']; } ?>
