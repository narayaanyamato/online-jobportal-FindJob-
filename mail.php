...
try {
    ...
    $mail->Subject = 'Email Varification Mail From FindJob.com !';
	...
	max-width: 560px;" class="container">
          <tr>
			...
			font-family: sans-serif;" class="header">
              <img border="0" vspace="0" hspace="0" src="https://img.freepik.com/premium-vector/find-job-logo-template-design_316488-886.jpg?w=740" width="200" height="58" alt="The Idea" title="FindJob">
          ...
          <tr>
			...
			padding-bottom: 5px;" class="button">
              <a href="http://localhost/jobportal/email-varifcation.php?email='.$email.'" target="_blank">
                <table border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;">
                  <tr>
					...
					color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href="http://localhost/jobportal/email-varifcation.php?email='.$email.'">
